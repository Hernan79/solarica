          ...
          <ul class="nav" role="navigation">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu" aria-labelledby="drop1">
                <li role="presentation"><a role="menuitem" tabindex="-1" href="r_usuarios.php" target="admin"><i class="icon-user"></i> Nuevo Usuario</a></li>
                <li role="presentation" class="divider"></li>
                <li role="presentation"><a role="menuitem" tabindex="-1" href="reg_facturas.php" target="admin"><i class="icon-file"></i> Facturas</a></li>
                <!--<li role="presentation" class="divider"></li>--> 
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu" aria-labelledby="drop2">
                <li role="presentation"><a role="menuitem" tabindex="-1" href="list_usuarios.php" target="admin"><i class="icon-th-list"></i> 
