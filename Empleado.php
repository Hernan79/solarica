          ...
          <ul class="nav" role="navigation">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu" aria-labelledby="drop1">
                <li role="presentation"><a role="menuitem" tabindex="-1" href="salones.php" target="admin"><i class="icon-folder-open"></i> Profesores</a></li>
                <li role="presentation"><a role="menuitem" tabindex="-1" href="salones.php" target="admin"><i class="icon-folder-open"></i> Profesoress</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu" aria-labelledby="drop2">
                ...
                <li role="presentation" class="divider"></li>
                <li role="presentation"><a role="menuitem" tabindex="-1" href="detalle.php" target="admin">Detalle de Efectivo</a></li>
                <li role="presentation" class="divider"></li>
                <li role="presentation"><a role="menuitem" tabindex="-1" href="reg_recibos.php" target="admin">Registrar Recibos</a></li>
                <li role="presentation" class="divider"></li>
